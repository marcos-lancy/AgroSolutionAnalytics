using AgroSolutions.Analytics.Service.Api.Middlewares;
using AgroSolutions.Analytics.Service.Application.AppServices;
...
{
    c.SwaggerDoc("v1", new() { Title = "Serviço de Análise e Alertas - AgroSolutions", Version = "v1", Description = "Este serviço processa dados de sensores e gera alertas." });
    c.EnableAnnotations();
